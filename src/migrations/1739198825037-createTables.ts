...
export class CreateTables1739198825037 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
            ...
            CREATE TABLE "D_Order" (
                ...
                "productDetails" nvarchar(100) NOT NULL,
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX "IDX_e36d1e1e51241ecf23cc810c37" ON "d_order_products_d_product"`);
    await queryRunner.query(`DROP INDEX "IDX_f41bb838a9730d33684ada8b2a" ON "d_order_products_d_product"`);
